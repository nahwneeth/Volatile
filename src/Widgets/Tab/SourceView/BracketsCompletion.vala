...
public class V.Editor.BracketsCompletion {
    ...
    V.SourceView current_source_view;

    private string previous_selection = "";

    public void activate (V.SourceView source_view) {
        ...
        current_buffer = source_view.buffer;

        if (current_source_view != null) {
            deactivate ();
        }

        current_source_view = source_view;
